...
plt.plot_normal(x, -2, 1, color='red', lw=2, ls='-', alpha=0.5)
plt.plot_normal(x, 2, 1.2, color='blue', lw=2, ls='-', alpha=0.5)
plt.plot_normal(x, 0, 0.8, color='green', lw=2, ls='-', alpha=0.5)
plt.plot_normal(x)
plt.plot_normal(x, cdf=True)
st.pyplot(plt)
